...
<body>
    <!-- Library Tools Edit Line, Polygon, Point -->
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.1.min.js"></script>
    <!-- Leaflet JS -->
    <script src="https://unpkg.com/leaflet@1.9.1/dist/leaflet.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/leaflet-draw@1.0.4/dist/leaflet.draw.min.js"></script>
    <!-- Terraformer, library WKT -->
    ...
    <!-- MAP -->
    <div id="map"></div>
    <!-- Modal Point dengan id pointModal -->
    ...
    <script>
        /* Initial Map, menembak objek html ber-id map langitude longitude, DIY dan zoom 10 */
        ...
        /* Draw Control, true = kontroler yang hidup */
        ...
        /* Draw Event, function nya created membuat */
        map.on(L.Draw.Event.CREATED, function(e) {
            var type = e.layerType,
                layer = e.layer;
            // Convert geometry to GeoJSON pada bagian layer itu akan menghasilkan file geojson
            var drawnItemJson = layer.toGeoJSON().geometry;
            // Convert GeoJSON to WKT, dari wkt akan mausk ke input
            var drawnItemWKT = Terraformer.WKT.convert(drawnItemJson);
            if (type === 'marker') {
                // Set value to input
                $('#input_point_geometry').html(drawnItemWKT);
                // Open Modal, dari modal atau form akan di simpan ke database
        ...
        /*Script deafult*/
        /*Script selanjutnya*/
        /* GeoJSON Point untuk menampilkan point pada muka peta*/
        var point = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                layer.on({
                    ...
                    /*Ketika mouse di sekitar objek akan menamppilkan keterangan nama */
        ...
        /* GeoJSON Polyline untuk menampilkan line pada muka peta*/
        ...
        /* GeoJSON polygon untuk menampilkan polygon pada muka peta*/
